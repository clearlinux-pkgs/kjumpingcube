...
Version  : 19.08.0
Release  : 12
URL      : https://download.kde.org/stable/applications/19.08.0/src/kjumpingcube-19.08.0.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.0/src/kjumpingcube-19.08.0.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.0/src/kjumpingcube-19.08.0.tar.xz.sig
...
%prep
%setup -q -n kjumpingcube-19.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565901774
mkdir -p clr-build
pushd clr-build
