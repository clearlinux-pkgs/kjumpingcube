...
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/kjumpingcube-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/kjumpingcube-22.12.3.tar.xz.sig
...
%prep
%setup -q -n kjumpingcube-22.12.3
cd %{_builddir}/kjumpingcube-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677789675
mkdir -p clr-build
pushd clr-build
