...
Version  : 24.12.1
Release  : 78
URL      : https://download.kde.org/stable/release-service/24.12.1/src/kjumpingcube-24.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/kjumpingcube-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/kjumpingcube-24.12.1.tar.xz.sig
...
%setup -q -n kjumpingcube-24.12.1
cd %{_builddir}/kjumpingcube-24.12.1
pushd ..
cp -a kjumpingcube-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736536011
mkdir -p clr-build
pushd clr-build
