...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/kjumpingcube-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/kjumpingcube-24.02.0.tar.xz.sig
...
%prep
%setup -q -n kjumpingcube-24.02.0
cd %{_builddir}/kjumpingcube-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710301175
mkdir -p clr-build
pushd clr-build
